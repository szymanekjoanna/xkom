        ...
        <div id="table" class="table-editable">
            <table class="table table-bordered table-responsive-md table-striped text-center"  id="userTable" >
                ...
                <tr>
                    ...
                    <th class="th-sm">Produkt<i class="fa fa-sort float-right" aria-hidden="true"></i></th>
                    <th class="th-sm">Cena<i class="fa fa-sort float-right" aria-hidden="true"></i></th>
                    <th class="th-sm">Kategoria<i class="fa fa-sort float-right" aria-hidden="true"></i></th>
                    <th class="th-sm">Procesor<i class="fa fa-sort float-right" aria-hidden="true"></i></th>
                    <th class="th-sm">Bateria<i class="fa fa-sort float-right" aria-hidden="true"></i></th>
                    <th class="th-sm">Waga<i class="fa fa-sort float-right" aria-hidden="true"></i></th>
                    <th class="th-sm">Szerokość<i class="fa fa-sort float-right" aria-hidden="true"></i></th>
                    <th class="th-sm">Pamięć RAM<i class="fa fa-sort float-right" aria-hidden="true"></i></th>
                    <th class="th-sm">Typ ekranu<i class="fa fa-sort float-right" aria-hidden="true"></i></th>
                    <th class="th-sm">Głębokość<i class="fa fa-sort float-right" aria-hidden="true"></i></th>
                    <th class="no-sort">Gwarancja<i class="fa fa-sort float-right" aria-hidden="true"></i></th>
                    <th class="no-sort">Karta graficzna<i class="fa fa-sort float-right" aria-hidden="true"></i></th>
                    <th class="no-sort">Dołączone akcesoria<i class="fa fa-sort float-right" aria-hidden="true"></i></th>
            ...
            <tbody>
                <c:forEach var="product" items="${products}">
                    <tr bgcolor="#ffffff">
                        ...
                        <td>${product.pamiecRAM}</td>
                        <td>${product.typEkranu}</td>
                        <td>${product.glebokosc}</td>
                        <td>${product.gwarancja}</td>
                        <td>${product.kartaGraficzna}</td>
                        <td>${product.dolaczoneAkcesoria}</td>
                        <%--<td><a href="/createTxtFile/${product.id}">Generuj .txt</a></td>--%>
                        <%--<td><a href="/updateProduct">Edit</a></td>--%>
                        <td>
                            <button class="btn btn-primary btn-sm" id="generateTXT">.txt</a> </button>
                        </td>
                        <td>
